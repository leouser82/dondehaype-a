...
export default function LoginMenu({ variant = 'header' }) {
  ...
  return (
    <div className={`login-menu ${variant}`} ref={caja}>
      <button type="button" className="google" onClick={() => setAbierto((v) => !v)}>
        Login
      </button>
      {abierto ? (
        <div className="login-options" role="menu">
          <button
            type="button"
            role="menuitem"
            onClick={async () => {
...
function GoogleMark() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.2-3.5 5.8-6.7 7.4l6.3 5.3C38.2 37.3 44 32 44 24c0-1.3-.1-2.5-.4-3.5z" />
    </svg>
  )
}
